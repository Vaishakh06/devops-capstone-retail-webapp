...
Replace `vaishakh06` with your Docker Hub username.

### Frontend
```bash
docker build -t vaishakh06/novacart-frontend:v1 ./frontend
docker tag vaishakh06/novacart-frontend:v1 vaishakh06/novacart-frontend:latest
docker push vaishakh06/novacart-frontend:v1
docker push vaishakh06/novacart-frontend:latest
```

### Product Service
```bash
docker build -t vaishakh06/novacart-product-service:v1 ./product-service
docker tag vaishakh06/novacart-product-service:v1 vaishakh06/novacart-product-service:latest
docker push vaishakh06/novacart-product-service:v1
docker push vaishakh06/novacart-product-service:latest
```

### Cart Service
```bash
docker build -t vaishakh06/novacart-cart-service:v1 ./cart-service
docker tag vaishakh06/novacart-cart-service:v1 vaishakh06/novacart-cart-service:latest
docker push vaishakh06/novacart-cart-service:v1
docker push vaishakh06/novacart-cart-service:latest
```
...
Before applying manifests, update image names in `k8s/*.yaml` from `vaishakh06/...` to your Docker Hub username.
